...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT(
    ...
    MO(1),     KC_CAPS,     KC_GRV,  KC_LALT, KC_LGUI, KC_SPC,  KC_DELT,  KC_ENT,  KC_BSPC,  KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, LCTL(LCMD(KC_Q))
  ),
  // navigation layer
  [1] = LAYOUT(
    KC_NO,     KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                       KC_F6,   KC_F7,   KC_F8,    KC_F9,  KC_F10,   KC_NO,
    KC_NO,     KC_NO,   KC_NO,   KC_HOME, KC_PGUP, KC_NO,                       KC_NO,   KC_NO,   KC_NO,    KC_NO,  KC_NO,    KC_NO,
    KC_NO,     KC_NO,   KC_NO,   KC_END,  KC_PGDN, KC_NO,                       KC_LEFT, KC_DOWN, KC_UP,    KC_RGHT,KC_NO,    KC_NO,
    KC_NO,     KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,                       KC_NO,   KC_NO,   KC_NO,    KC_NO,  KC_NO,    KC_NO,
    KC_NO,     KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_SPC,  KC_DELT,  MACRO_ENT_L_DEF,    KC_BSPC,   KC_NO,   KC_NO,    KC_VOLD,  KC_VOLU,    KC_NO
  )
